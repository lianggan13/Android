...
public class MysqlSeed {
    ...
    public static List<NewsEntity> loadLocalNews() {
        ...
        newsList.add(createNewsEntity(1, "安全联锁桌面客户端", "张亮",
                "author.png", 3, "2020-07-31 22:23:00", 3,
                List.of("asis_baise01.png", "asis_baise02.png", "asis_wens101.png")));

        newsList.add(createNewsEntity(1, "安全联锁桌面客户端", "张亮",
                "author.png", 3, "2020-07-31 22:23:00", 2,
                List.of("asis_baise01.png", "asis_baise02.png", "asis_wens101.png")));

        newsList.add(createNewsEntity(1, "安全联锁桌面客户端", "张亮",
                "author.png", 3, "2020-07-31 22:23:00", 1,
                List.of("asis_baise01.png", "asis_baise02.png", "asis_wens101.png")));

        newsList.add(createNewsEntity(1, "操作终端客户端", "张亮",
                "author.png", 3, "2020-07-31 22:23:00", 3,
                List.of("asis_plct01.png", "asis_plct02.png", "asis_wens101.png")));
        ...
        newsList.add(createNewsEntity(1, "遗留物检测客户端", "张亮",
                "author.png", 3, "2020-07-31 22:23:00", 3,
        ...
        newsList.add(createNewsEntity(1, "无电安全联锁客户端", "张亮",
                "author.png", 3, "2020-07-31 22:23:00", 3,
                List.of("asis_powerless.png", "rrd02.png", "rrd03.png")));
        ...
        newsList.add(createNewsEntity(1, "巡检机器人 HMI 客户端", "张亮",
                "author.png", 3, "2020-07-31 22:23:00", 3,
    ...
    private static NewsEntity createNewsEntity(int newsId, String newsTitle, String authorName,
                                               String headerUrl, int commentCount, String releaseDate, int type, List<String> thumbUrls) {
