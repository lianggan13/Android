...
import com.example.zhangliang.videoprojects.listener.OnItemClickListener;
...
//        vh.tvCollect.setText(String.valueOf(videoEntity.getCollectNum()));
        ...
        imageLoader.loadCircle(videoEntity.getHeadurl(), vh.imgHeader);
        imageLoader.load(videoEntity.getCoverurl(), vh.mThumb);
